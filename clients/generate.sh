...
npx @openapitools/openapi-generator-cli generate -i http://localhost:8787/openapi.json -g typescript-axios -o clients/typescript --git-user-id "kwila-cloud" --git-repo-id "smoketree" --additional-properties "npmName=smoketree,licenseName=MIT"
